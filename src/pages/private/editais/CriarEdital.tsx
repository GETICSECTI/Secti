      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Preencha os campos abaixo para criar um novo edital</p>
          </div>
          <button
            type="button"
        ...
        {erro && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-sm font-medium text-red-800">Erro ao criar edital</h3>
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow-sm rounded-lg border border-gray-200 p-6 space-y-6">
          ...
          <div className="flex items-center gap-3 pt-6 border-t border-gray-200">
            ...
            >
              {isSubmitting ? 'Criando...' : 'Criar Edital'}
            </button>
            <button
              type="button"
              onClick={() => navigate('/admin/editais')}
