...
export const CriarRelatorios = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const mensagemErro = error instanceof Error ? error.message : 'Erro ao criar relatório';
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Preencha os campos abaixo para criar um novo relatório</p>
          </div>
          <button
            type="button"
        ...
        {erro && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-sm font-medium text-red-800">Erro ao criar relatório</h3>
