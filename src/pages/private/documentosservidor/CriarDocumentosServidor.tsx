...
export const CriarDocumentosServidor = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate('/admin/documentos-servidor');
      }, 1500);
    } catch (error) {
    ...
    <PrivateLayout>
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Novo Documento do Servidor</h1>
            <p className="text-gray-600 mt-2">Preencha os campos abaixo para criar um novo documento do servidor</p>
          </div>
          <button
            type="button"
            onClick={() => navigate('/admin/documentos-servidor')}
